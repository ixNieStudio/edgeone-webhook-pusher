...
import type { Channel, ChannelType, WebhookConfig } from './channel.js';
import type { MessageType, PushMode } from './app.js';
...
export interface InlineWebhookConnection extends WebhookConfig {
  atMobiles?: string[];
  atAll?: boolean;
}
...
export interface ResolvedAppContext {
  deliveryConfig: AppDeliveryConfig;
